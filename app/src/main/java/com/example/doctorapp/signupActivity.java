...
public class signupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        alreadyDoctor = findViewById(R.id.alreadyDoctor);
                    ...
                    firebaseAuth.createUserWithEmailAndPassword(email, password)
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.getException() instanceof FirebaseAuthUserCollisionException) {
                                ...
                                Intent intent = new Intent(signupActivity.this, signUpPageTwo.class);
        ...
        alreadyDoctor.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(signupActivity.this, DoctorRegister.class);
                startActivity(intent);
            }
        });
    }
